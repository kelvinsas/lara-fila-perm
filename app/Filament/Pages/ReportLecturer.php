...
class ReportLecturer extends Page
{
        ...
        return [
            Action::make('Filtros')
                ->action(function (array $data): void {
                    session()->put('REPORT_LECTURER_DATA_FILTER', $data);
                })
            ...
            ActionGroup::make([
                Action::make('Excel')->action(function () {
                    return Excel::download(new ExportProductionByLecturer(), 'ExportProductionByLecturer_'.Carbon::now().'.xlsx');
    ...
    protected function getFilterDate($format = 'Y-m-d') {
        $dateSession = session()->get('REPORT_LECTURER_DATA_FILTER');
